 ...
 * @author FrankS
 */
public class FormEstadoAuto extends javax.swing.JFrame {

    /**
     * Creates new form FormEstadoAuto
     */
    public FormEstadoAuto() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Administración Estado de Auto");

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(45, 45, 45));
        jLabel2.setText("Estado de Auto");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       Clases.CEstadoAuto estadoAuto = new Clases.CEstadoAuto();
       estadoAuto.eliminarEstadoAuto(txtCodEstadoAuto);
       estadoAuto.MostrarEstadoAuto(tbestadoauto);
       txtCodEstadoAuto.setText("");
       txtEstadoAuto.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormEstadoAuto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormEstadoAuto().setVisible(true);
            }
        });
    }
